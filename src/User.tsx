...
const SkillInfo = [
    ...
    {
        title: "Backend",
        skills: ["Java", "Spring-boot","JPA","SQL","Microservices", "Kafka","MySQL", "AWS", "Docker"]
    },
    {
        title: "Languages",
    ...
    {
        title: "Tools",
        skills: ["Git", "Github", "VS Code", "Postman", "Mysql", "Spring Tool Suite","Kibana","RabbitMQ"]
    }
]
const socialLinks = [
    { link: "https://github.com/narendrapatidargmailcom", icon: IconBrandGithub },
    { link: "https://www.linkedin.com/in/narendra-patidar-8882b218b", icon: IconBrandLinkedin },
    { link: "https://www.instagram.com/this.naren", icon: IconBrandInstagram }, 
    { link: "https://leetcode.com/u/NarendraSanewa", icon: IconBrandLeetcode }
];
...
const ExperienceInfo = [
    {
        ...
        skills: ["Springboot", "React JS", "SQL", "Microservices", "MySQL", "JPA", "Kafka","AWS"]
    },
    {
        role: "System Engineer",
        company: "TCS",
        date: "APR 2022 - Sep 2024",
        desc: " I leveraged my skills in Java, Python and MySQL to design and implement web application, ensuring robust software validation. I optimized database performance and reliability, and collaborated with cross-functional teams to enhance system operations and ensure seamless integration.",
        skills: ["Java", "MySQL", "Hibernate", "Microservices", "Jenkins", "JIRA", "AWS"]
    },
    {
        ...
        desc: " I leveraged my skills in Java, Python and MySQL to design and implement web application, ensuring robust software validation. I optimized database performance and reliability, and collaborated with cross-functional teams to enhance system operations and ensure seamless integration.",
        skills: ["Java", "MySQL", "Hibernate", "Spring boot", "Jenkins", "JIRA"]
    }
]
const Slugs = [
    "typescript",
